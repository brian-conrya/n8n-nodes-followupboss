...
export async function getTeams(this: ILoadOptionsFunctions, filter?: string): Promise<INodeListSearchResult> {
...
export async function getCalls(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/calls', {}, {}, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getNotes(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/notes', {}, {}, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getEvents(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/events', {}, {}, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getAppointments(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/appointments', {}, {}, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getEmailMarketingCampaigns(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/emCampaigns', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getActionPlansPeople(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/actionPlansPeople', {}, {}, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getAutomationsPeople(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/automationsPeople', {}, {}, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
...
export async function getCustomFields(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
...
export async function getLenders(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        role: 'Lender',
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/users', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getTextMessageTemplates(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/textMessageTemplates', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getPipelines(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/pipelines', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getAppointmentTypes(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/appointmentTypes', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getAppointmentOutcomes(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/appointmentOutcomes', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getEmailTemplates(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/templates', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getGroups(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/groups', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
...
export async function getPonds(this: ILoadOptionsFunctions, _filter?: string, paginationToken?: string): Promise<INodeListSearchResult> {
    const query: IDataObject = {
        sort: 'name',
    };
    const { data, nextUrl } = await apiRequestPagination.call(this, 'GET', '/ponds', {}, query, paginationToken);
    const mapped = data.map((item: IDataObject) => ({
        name: item.name as string,
        value: item.id as number,
    }));
