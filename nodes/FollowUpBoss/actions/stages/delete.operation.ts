...
import { toInt, updateDisplayOptions, wrapDeleteSuccess, getStageIdProperty } from '../../helpers/utils';
...
const properties: INodeProperties[] = [
	{
		...
		description:
			'ID of the stage to delete. Choose from the list, or specify an ID.',
	},
];
