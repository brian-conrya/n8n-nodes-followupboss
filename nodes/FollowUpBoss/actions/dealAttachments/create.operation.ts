...
const properties: INodeProperties[] = [
	{
		...
		default: '',
		required: true,
		description: 'The ID of the deal you want to add an attachment to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'URI',
		name: 'uri',
